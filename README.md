...
1. The project proposal is due __(DATE TBD)__ 11:59:59 PM, but feel __strongly encouraged__ to submit earlier to get quicker feedback.
2. Your final project demo video is due on __(DATE TBD)__ at 5 PM.
3. Your final project hand-in (writeup + code) is due on Tuesday __March 19th__.
...
Cool areas in graphics to draw from, but would likely be too complex to fully implement in a final project. But feel free to draw on these in your own proposals! You can pick portions of them to implement based on what you’ve learned in this class:
